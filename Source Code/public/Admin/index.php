		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<h1 class="h3 mb-4 text-gray-800 text-center">🏠 Smart Home Admin Panel</h1>
					<div class="row justify-content-center">
						...
						<div class="col-12 col-sm-6 col-md-4 mb-4">
							<div class="card shadow device-card text-center p-3">
								...
								<p>Trạng thái tự động: <span id="light1-auto">--</span></p>
								<p>Trạng thái: <span id="light1-status">--</span></p>
								<button id="light1-btn" class="btn btn-primary" onclick="toggleAutoMode('light1')">Chế
									độ</button>
							</div>
						</div>
						...
						<div class="col-12 col-sm-6 col-md-4 mb-4">
							<div class="card shadow device-card text-center sensor p-3">
								<h5 class="card-title">Cảm biến Ánh sáng LM393</h5>
								<p>Độ sáng: <span id="lm393-status">--</span></p>
								<p>Cập nhật: <span id="lm393-last">--</span></p>
							</div>
						</div>
